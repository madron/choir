...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('member_member', 'role',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='member_role_pk', null=True, to=orm['member.Role']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Member.role'
        db.delete_column('member_member', 'role_id')
    ...
    models = {
        ...
        'member.member': {
            'Meta': {'ordering': "('role__order', 'role__name', 'surname', 'name')", 'object_name': 'Member'},
            ...
            'role': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'member_role_pk'", 'null': 'True', 'to': "orm['member.Role']"}),
