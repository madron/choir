...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Member.mobile_number'
        db.add_column('member_member', 'mobile_number',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

        # Adding field 'Member.address'
        db.add_column('member_member', 'address',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Member.city'
        db.add_column('member_member', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Member.province'
        db.add_column('member_member', 'province',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Member.zip_code'
        db.add_column('member_member', 'zip_code',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Member.mobile_number'
        db.delete_column('member_member', 'mobile_number')

        # Deleting field 'Member.address'
        db.delete_column('member_member', 'address')

        # Deleting field 'Member.city'
        db.delete_column('member_member', 'city')

        # Deleting field 'Member.province'
        db.delete_column('member_member', 'province')

        # Deleting field 'Member.zip_code'
        db.delete_column('member_member', 'zip_code')
    ...
    models = {
        ...
        'member.member': {
            'Meta': {'ordering': "('surname', 'name')", 'object_name': 'Member'},
            ...
            'roles': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['member.Role']", 'null': 'True', 'blank': 'True'}),
